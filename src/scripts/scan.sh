...
whoami
docker run -e SEC1_INTEGRATION_NAME="${SEC1_INTEGRATION_NAME}" -e INPUT_APIKEY="${PARAM_SEC1_API_KEY}" -v /home/circleci/project:/tmp/circleci-workspace -it --rm sec1security/sec1-foss-security:v1
